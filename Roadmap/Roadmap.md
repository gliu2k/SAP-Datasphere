...
> [!Important]
> **The ABAP CDS View, the second approach, is [SAP Best Practice](https://community.sap.com/t5/technology-blogs-by-sap/sap-datasphere-sap-s-4hana-your-guide-to-seamless-data-integration/ba-p/13662817)**. It is mainly used in the init/delta data loading for the transaction data.
>
> **Remoet Tables**, mapping to **ABAP CDS Views**, are mainly used in the full data loading for the master data. These CDSViews don't need to have **@Analytics.dataExtraction.enabled**.
>
