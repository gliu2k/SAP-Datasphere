...
> -	**Dimension/Text/Hierarchy**: master data are used in the association of fact, view or other dimension tables 
...
> [!Note]
> Either **DAC** or **local table** can be shared/reused in other **Views** or **DACs** if they have the same restriction on users, fields and values.
